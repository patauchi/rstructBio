...
ini_noparametric <- sidebarLayout(position = "left",
                                sidebarPanel(
                                  ...
                                  conditionalPanel("input.getTypeDistribution == true",
                                                   ...
                                                   br(),
                                                   bsButton("runTwoDistKolm",  "Run",   icon = icon("upload", lib = "glyphicon"),  style = "primary"),
                                  ...
                                  conditionalPanel("input.getSignedRankWilcoxon == true",
                                                   ...
                                                   br(),
                                                   bsButton("runOneSampleWilcoxon", "Run",  icon = icon("upload", lib = "glyphicon"),style = "primary"),
                                                   busyIndicator("Loading...",wait = 0),
                                                   br(),
                                  ...
                                  conditionalPanel("input.getKNoParametricSample == true",
                                                   ...
                                                   br(),
                                                   bsButton("runParMeans","Run",icon = icon("upload", lib = "glyphicon"),style = "primary"),
                                                   busyIndicator("Loading...",wait = 0),
                                                   br(),
                                  ),
                                  ############################## END CAPSULES
